...
jQuery(function($) {
    ...
    /*--------------------------------
        Sparkline Chart
     --------------------------------*/
    _SETTINGS.dbSparklineChart = function() {
    ...
    /*--------------------------------
        Easy PIE
     --------------------------------*/
    _SETTINGS.dbEasyPieChart = function() {
    ...
    /*--------------------------------
        Morris 
     --------------------------------*/
    _SETTINGS.dbMorrisChart = function() {
    ...
    /*--------------------------------
        Rickshaw charts
     --------------------------------*/
    _SETTINGS.dbRickshawChart = function() {
    ...
    /*--------------------------------
         gauge meter
     --------------------------------*/
    _SETTINGS.dbGaugemeter = function() {
    ...
    $(document).ready(function() {
        _SETTINGS.dbSparklineChart();
        //_SETTINGS.dbEasyPieChart();
        _SETTINGS.dbMorrisChart();
        //_SETTINGS.dbRickshawChart();
        //_SETTINGS.dbGaugemeter();
    });
